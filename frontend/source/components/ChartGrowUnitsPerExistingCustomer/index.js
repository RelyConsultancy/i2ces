...
const ChartGrowUnitsPerExistingCustomer = (data, type) => {
        ...
        return Grid({
          ...
          items: [
              B(
                ...
                B({ className: style.chart }, ChartGrowUnitsPerExistingCustomer(data))
              ),
              B(
                H3({ className: 'i2c-chart-title' }, 'Brand'),
                B({ className: style.chart }, ChartGrowUnitsPerExistingCustomer(data, 'brand'))
              )
          ]
      })
    }
